...
string gFunctionList[FunctionCount] = { // quote 矪瞶
  ...
  "#<procedure list>", "#<procedure define>", "#<procedure car>", "#<procedure cdr>", "#<procedure atom?>", 
  "#<procedure pair?>", "#<procedure list?>", "#<procedure null?>", "#<procedure integer?>", 
  "#<procedure real?>", "#<procedure number?>", "#<procedure string?>", "#<procedure boolean?>", 
  "#<procedure symbol?>", "#<procedure +>", "#<procedure ->", "#<procedure *>", "#<procedure />", 
  "#<procedure not>", "#<procedure and>", "#<procedure or>", "#<procedure >>", "#<procedure >=>", 
  "#<procedure <>", "#<procedure <=>", "#<procedure =>", "#<procedure string-append>", 
  "#<procedure string>?>", "#<procedure string<?>", "#<procedure string=?>", "#<procedure eqv?>", 
  "#<procedure equal?>", "#<procedure begin>", "#<procedure if>", "#<procedure cond>"
                                      };
